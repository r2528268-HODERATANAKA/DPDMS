...
public class ZoonoticIncidentService {
    ...
    public List<ZoonoticIncident> findAllScoped(String callerRole, String callerWard, String callerHazard) {
        if (callerHazard != null && !callerHazard.isBlank()
                && !"*".equals(callerHazard) && !callerHazard.equalsIgnoreCase("zoonotic")) {
            throw new ForbiddenOperationException("This account is not authorised for the zoonotic hazard");
        }
