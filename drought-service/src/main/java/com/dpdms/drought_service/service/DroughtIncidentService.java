...
public class DroughtIncidentService {
    ...
    public List<DroughtIncident> findAllScoped(String callerRole, String callerWard, String callerHazard) {
        if (callerHazard != null && !callerHazard.isBlank()
                && !"*".equals(callerHazard) && !callerHazard.equalsIgnoreCase("drought")) {
            throw new ForbiddenOperationException("This account is not authorised for the drought hazard");
        }
